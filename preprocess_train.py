...
output_jsonl = '/data/250010171/code/EigeNet/data/AcousticRooms_train.jsonl'
...
def main():
    all_rir_list = glob.glob(os.path.join(RIR_ROOT, '**', '*.wav'), recursive=True)
    print(f"find {len(all_rir_list)} rir files")

...
from models.ca_v1_g2_align2.flow_matching_transformer.test_infer_pipeline import InferencePipeline as RIR_InferencePipeline
...
if __name__ == "__main__":
    # # no align
    # fmt_cfg = '/data/250010171/code/EigeNet_discriminant/egs/rir/flow_matching_transformer/debug_EigeNet_v1_g2_ca_noalign.json'
    # fmt_ckpt = "/data/share/amphion/data/eigenet/ckpts/discriminant/ablation_ca_noalign/checkpoint/epoch-0009_step-0007600_loss-3.324408"
    
    # align
    fmt_cfg = os.path.join(src, f"egs/rir/flow_matching_transformer/debug_EigeNet_v1_g2_ca_align2.json")
    fmt_ckpt = "/data/share/amphion/data/eigenet/ckpts/discriminant/ablation_ca_align/checkpoint/epoch-0009_step-0007000_loss-2.394054"

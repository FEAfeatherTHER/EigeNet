...
from models.aa_v1_g2_align2_toy3_abla_alignloss.flow_matching_transformer.fmt_model import FlowMatchingTransformer
...
class FMTTrainer(BaseTrainer):
    ...
    def get_align_features(self, audio): # 
        ...
        align_features = extract_stft_energy_db(audio, sr=self.sample_rate, frame_rate=self.cfg.preprocess.frame_rate).transpose(1, 2)

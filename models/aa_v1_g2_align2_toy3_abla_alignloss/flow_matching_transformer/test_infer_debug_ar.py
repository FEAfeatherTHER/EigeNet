...
from models.aa_v1_g2_align2_toy3_abla_alignloss.flow_matching_transformer.test_infer_pipeline import InferencePipeline as RIR_InferencePipeline
...
if __name__ == "__main__":
    # align 0
    fmt_cfg = os.path.join(src, f"egs/rir/flow_matching_transformer/debug_EigeNet_v1_g2_aa_align2_toy3_abla_alignloss_0.json")
    fmt_ckpt = "/data/250010171/code/EigeNet_discriminant/ckpts/discriminant/base2_aa_align_abla_alignloss_0/checkpoint_backup/epoch-0009_step-0007600_loss-2.183239"
    
    # # align 1
    # fmt_cfg = os.path.join(src, f"egs/rir/flow_matching_transformer/debug_EigeNet_v1_g2_aa_align2_toy3_abla_alignloss_1.json")
    # fmt_ckpt = "/data/250010171/code/EigeNet_discriminant/ckpts/discriminant/base2_aa_align_abla_alignloss_1/checkpoint/epoch-0008_step-0007000_loss-2.204861"

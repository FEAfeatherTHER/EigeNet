...
class FlowMatchingTransformer(nn.Module):
    ...
    def forward(self, ir_z, cc_depth_map, cc_src_loc):
        ...
        ir_hidden_states = self.audiovisual_encoder(ref_view_av_tokens, tgt_view_av_tokens)#(B, N, t+2, dim*2)
        tgt_ir_acoustic_hidden_states = ir_hidden_states[:, -1, 2:]
        pred_tgt_z = self.out_proj(tgt_ir_acoustic_hidden_states)#(B, t, dim)

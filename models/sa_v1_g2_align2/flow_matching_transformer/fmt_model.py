...
from models.layers.transformer_decoder import Transformer_Decoder, AA_Transformer_Decoder, DiT
...
class FlowMatchingTransformer(nn.Module):
    ...
    def aggregator(self, ir_tokens, label_tokens):
        ...
        context = rearrange(context, "b n t d -> b (n t) d")
        out = self.av_transformer(context)
        out = rearrange(out, "b (n t) d -> b n t d", n = N)
        ir_tokens = out[:,:,1:]
        label_tokens = out[:,:,0:1]

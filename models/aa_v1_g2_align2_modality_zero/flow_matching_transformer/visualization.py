...
def main_debug(inference_pipeline, evaluator, cfg, batch):
    ...
    return edt_error, c50_error, t60_error, tgt_ir, recon_audio
...
if __name__ == "__main__":
    ...
    out_dir = '/data/250010171/code/EigeNet_discriminant/visualization/out'
    ...
    #推理
    edt_error, c50_error, t60_error, gt_ir, pred_ir = main_debug(inference_pipeline, evaluator, cfg, batch)

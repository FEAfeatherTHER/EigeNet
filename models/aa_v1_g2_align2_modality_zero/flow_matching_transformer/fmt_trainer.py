...
from models.aa_v1_g2_align2_modality_zero.flow_matching_transformer.fmt_model import FlowMatchingTransformer
...
class FMTTrainer(BaseTrainer):
    ...
    def get_align_features(self, audio, layer = None): # 
        ...
        audio:(B*N, 1, T)
        """
        codes = self.audio_codec.encode(audio, layer)#(B, layer, t)
        align_features = self.audio_codec.model.quantizer.from_codes(codes)[0]#(B, 1024, t)
        align_features = align_features.transpose(-1, -2)#(B, t, 1024)

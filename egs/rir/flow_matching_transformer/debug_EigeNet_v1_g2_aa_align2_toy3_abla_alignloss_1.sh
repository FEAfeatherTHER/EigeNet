...
exp_config="$exp_dir/debug_EigeNet_v1_g2_aa_align2_toy3_abla_alignloss_1.json"
# 对齐：进tf前，对tgt_init_ir_token进行处理，不实用alignmetloss
exp_name="base2_aa_align_abla_alignloss_1"
...
accelerate launch \
    ...
    "${work_dir}"/train_v1_g2_aa_align2_toy3_abla_alignloss.py \
    --config=$exp_config \
    --exp_name=$exp_name \
    --log_level debug \

...
exp_config="$exp_dir/debug_EigeNet_v1_g2_aa_align2_toy3.json"
# 对齐：进tf前，对tgt_init_ir_token进行处理
exp_name="base2_aa_align_toy3.4"
...
accelerate launch \
    ...
    "${work_dir}"/train_v1_g2_aa_align2_toy3.py \
    --config=$exp_config \
    --exp_name=$exp_name \
    --log_level debug \

...
dataset_root = '/data/share/amphion/data/noise-and-rirs/AcousticRooms'
pickel_path = '/data/250010171/code/EigeNet/data/seen_test_split.pkl'
...
output_jsonl = '/data/250010171/code/EigeNet_discriminant/data/AcousticRooms_test_seen.jsonl'
...
def seg_info_generator(all_rir_list):
    for rir_path in all_rir_list:
        rir_path = os.path.join(RIR_ROOT, rir_path)
...
def main():
    all_rir_list = []
    with open(pickel_path, "rb") as fin:
        all_rir_list = pickle.load(fin)
